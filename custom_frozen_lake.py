...
base_env = gym.make('FrozenLake-v1',
...
env = CustomFrozenLake(
    base_env,
    hole_reward=-1.0,    # Penalty for falling in a hole
    step_reward=-0.1,    # Small penalty for each step to encourage faster completion
