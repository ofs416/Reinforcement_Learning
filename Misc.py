...
def energy_cons_check(trajectory: np.ndarray, g: float, length: float, mass: float) -> None:
...
def plot_state(xaxis: np.ndarray, yaxis: np.ndarray, title: Optional[str], legends: Optional[List[str]]) -> None:
